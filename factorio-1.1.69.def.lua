...
---@shape CapsuleAction
  ...
  ---@field attack_parameters AttackParameters|nil @nilable; Only present when `type` is `"throw"` or `"use-on-self"`.
  ---@field equipment string|nil @nilable; Only present when `type` is `"equipment-remote"`. It is the equipment prototype name.
...
---@shape WaitCondition
  ...
  ---@field ticks uint|nil @nilable; Number of ticks to wait or of inactivity. Only present when `type` is `"time"` or `"inactivity"`.
  ---@field condition CircuitCondition|nil @nilable; Only present when `type` is `"item_count"`, `"circuit"` or `"fluid_count"`.
